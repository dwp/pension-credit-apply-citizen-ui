  ...
  let claim = Object.assign(Object.create(null), {
    ...
    whereClaimantLives: {
      ...
      ...(isYes(d.permanentlyInCareHome) ? {} : {
        ...
        hasMortgage: traversed(WP.MORTGAGE) ? isYes(d.hasMortgage) : undefined,
        supportWithInterest: traversed(WP.HOME_LOAN) ? isYes(d.wantsSMI) : undefined,
        equityRelease: traversed(WP.EQUITY_RELEASE) ? isYes(d.equityRelease) : undefined,
        shareRentOrMortgage: traversed(WP.SHARE_RENT_MORTGAGE) ? isYes(d.shareRentMortgage) : undefined,
      }),
    ...
    income: {
      ...
      employedPaidWorkDescription: !isYes(d.hasEmploymentIncome) ? undefined : d.employerDetails,
