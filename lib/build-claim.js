...
const getOwnershipEnum = (langCode) => ({
  own: 'OWN',
  rent: 'RENT',
  other: 'OTHER',
...
module.exports = (plan, context, language = 'en') => {
  ...
  let claim = Object.assign(Object.create(null), {
    ...
    claimant: {
      ...
      preferredLanguage: d.preferredLanguage === 'other' ? d.preferredLanguageOther : d.preferredLanguage,
    ...
    whereClaimantLives: {
      ...
      ...(isYes(d.permanentlyInCareHome) ? {} : {
        ...
        serviceChargesAmount: !isYes(d.paysServiceCharges) ? undefined : sanitiseMoney(d.serviceChargesAmount),
        groundRent: isYes(d.paysGroundRent),
        groundRentAmount: !isYes(d.paysGroundRent) ? undefined : sanitiseMoney(d.groundRentAmount),
